...
public class ContaDAO {
    ...
    public void salvar(DadosAberturaConta dadosDaConta) {
        ...
        // Fazendo a persistencia dos dados na ordem do INSERT
        try {
    ...
    public Set<Conta> listar(){
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                Boolean estaAtivar = resultSet.getBoolean(6);

                DadosCadastroCliente dadosCadastroCliente =
                        new DadosCadastroCliente(nome, cpf, email);
                Cliente cliente = new Cliente(dadosCadastroCliente);

                contas.add(new Conta(numero, saldo ,cliente, estaAtivar));
            }
    ...
    public Conta listarPorNumero(Integer numero) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                conta = new Conta(numeroRecuperado, saldo, cliente, estaAtivar);
            }
            resultSet.close();
            ps.close();
            conn.close();
